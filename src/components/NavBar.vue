    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            ...
            <form class="d-flex">
                ...
                <div v-if="this.connection !== ''" class="dropdown">
                    <div v-if="this.sender === ''" class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="selectAccountBtn">
                            <li><button @click="handleTeam" class="dropdown-item" type="button">Team</button></li>
                            <li><button @click="handleAdvisors" class="dropdown-item" type="button">Advisors</button></li>
                            <li><button @click="handlePrivateInv" class="dropdown-item" type="button">PrivateInv</button></li>
                            <li><button @click="handleReserves" class="dropdown-item" type="button">Reserves</button></li>
                        </ul>
                    </div>
                    <div v-else class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="connectWalletBtn">
                            ...
                            <li><button @click="handleChangeAccount" class="dropdown-item" type="button">Change Account</button></li>
                        </ul>
                    </div>
                </div>
                <div v-else class="dropdown">
...
export default {
    ...
    methods: {
        ...
        handleTeam() {
            this.$emit("connectTeam");
        },
        handleAdvisors() {
            this.$emit("connectAdvisors");
        },
        handlePrivateInv() {
            this.$emit("connectPrivateInv");
        },
        handleReserves() {
            this.$emit("connectReserves");
        },
    },
};
</script>
